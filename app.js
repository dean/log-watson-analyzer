...
app.post('/', function(req, res){
  ...
  fs.readFile('logs/logfile.txt', 'utf8', function (err,data) {
    ...
    lines = data.split('\n');
    var line = '';
    console.log("Waiting on analyzing...");
    console.log(lines.length);
    for(var i=0; i<lines.length; i++) {
      // This is to get past all the date and time shit.
      line = lines[i].slice(21);
      console.log(line);
      if (line.lastIndexOf('@', 0) === 0 || line.lastIndexOf('%' + name, 0) === 0) {
        line = line.slice(1);
      }
    ...
    create_profile_request(profile_options,text)(function(error,profile_string) {
